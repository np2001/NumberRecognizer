...
private:
	...
	void DebugFigureGroups(const cv::Mat& gray_image, const SNFigureGroup& group, int scale = 1);
	void DebugFigureGroups(const cv::Mat& gray_image, const SNFigureGroups& group, int scale /*= 1*/);
